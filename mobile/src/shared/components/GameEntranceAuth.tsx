// src/components/GameEntranceAuth.tsx - Stadium Tunnel Auth Component
...
// Adapted for our Nepal-themed pickup sports app
...
export default function GameEntranceAuth({ countdownTo }: Props) {
  ...
  return (
    <div className="mt-5">
      ...
      <div className="flex items-center justify-center gap-3">
        <button 
          className={`${pillBtn} bg-white text-slate-900 hover:bg-slate-100`} 
