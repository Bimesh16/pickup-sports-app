...
export const ESewaPayment: React.FC<ESewaPaymentProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const transactionId = 'ESEWA' + Math.random().toString(36).substring(2, 10).toUpperCase();
      setLoading(false);
      setStep('success');
    ...
    return (
      <Card className="p-6 max-w-md mx-auto">
        <div className="text-center py-8">
          <Loader2 className="h-12 w-12 animate-spin mx-auto mb-4 text-[#60BB46]" />
  ...
  if (step === 'success') {
    return (
      <Card className="p-6 max-w-md mx-auto">
        <div className="text-center py-8">
          <div className="w-16 h-16 bg-[#60BB46] rounded-full flex items-center justify-center mx-auto mb-4">
            <CheckCircle className="h-8 w-8 text-white" />
          </div>
          <h3 className="text-xl font-bold text-[#60BB46] mb-2">
            Payment Successful!
          </h3>
          <p className="text-[var(--text-muted)]">
  ...
  return (
    <Card className="p-6 max-w-md mx-auto">
      <div className="text-center mb-6">
        <div className="w-16 h-16 bg-[#60BB46]/15 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <div className="bg-[var(--bg-muted)] rounded-lg p-4 mb-6">
        <div className="flex justify-between items-center">
          ...
          <span className="text-xl font-bold text-[#60BB46]">
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-4">
          ...
          <div className="pt-2 space-y-2">
            <Button
              type="submit"
              className="w-full bg-[#60BB46] hover:bg-[#60BB46]/90"
              disabled={loading}
            >
              {loading ? (
                <>
