...
/**
 * AI-generated game recommendation for users.
 */
@Entity
...
public class GameRecommendation {
    ...
    @JoinColumn(name = "recommended_game_id", nullable = false)
    private Game recommendedGame;
