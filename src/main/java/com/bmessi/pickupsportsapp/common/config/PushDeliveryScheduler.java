...
public class PushDeliveryScheduler {
    ...
    private final com.bmessi.pickupsportsapp.common.config.properties.VapidProperties vapid;
    private final com.bmessi.pickupsportsapp.common.config.properties.PushDeliveryProperties props;
